...
<div class="container">
  ...
  <form action="users?action=update&id=${user.id}" method="post">
    <div class="mb-3">
      ...
      <input type="text" id="nom" name="nom" value="${user.nom}" class="form-control" placeholder="Enter user name" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="password" id="password" name="password" value="${user.password}" class="form-control" placeholder="Enter password" required>
    </div>
    <div class="mb-3">
